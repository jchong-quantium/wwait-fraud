CREATE OR REPLACE VIEW fraud.ariba_po_invoice_vw
AS
WITH
  vendors AS (
  ...
  po_data_line_agg AS (
    ...
    -- , ltrim(ar_po.Cost_Center_Id,'0') as Cost_Center_Id,
    -- ar_po.Cost_Center
    -- , bu.EmployeeDivisionDesc as BU
    FROM
...
SELECT DISTINCT
  ar_po.*, invoice_agg.*, Supplier_Custom_Category_L2
