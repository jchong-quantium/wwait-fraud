...
WITH
  ...
  po_data_line_agg AS (
    ...
    WHERE
      ...
      -- Project scope is calendar 2024+; rolling window was silently
      -- dropping Jan–May 2024 each day it ran.
  ...
  invoice_agg AS (
    ...
    WHERE
      -- Hard lower bound of 2024-01-01 — matches po_data_line_agg above.
